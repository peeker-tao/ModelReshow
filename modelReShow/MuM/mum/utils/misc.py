...
def save_model(step, model, model_without_ddp, optimizer, loss_scaler, checkpoint_path):
    if loss_scaler is not None:        
        ...
        raise NotImplementedError("This step is not implemented")
        client_state = {'step': step}
        model.save_checkpoint(save_dir=args.output_dir, tag=checkpoint_path, client_state=client_state)
